...
class ExpandebleScreen extends StatefulWidget {
  ...
  @override
  State<ExpandebleScreen> createState() => _ExpandebleScreenState();
}

class _ExpandebleScreenState extends State<ExpandebleScreen> {
  ...
  void _onScroll() {
    ...
    double newHeight = (_maxHeight - offset).clamp(_minHeight, _maxHeight);
    setState(() {
        ...
        children: [
          Padding(
            ...
            child: TweenAnimationBuilder<double>(
              tween: Tween<double>(begin: _maxHeight, end: _currentMapHeight),
          ...
          Expanded(child: eczaneListView(dataList)),
        ],
      ),
    );
  }
